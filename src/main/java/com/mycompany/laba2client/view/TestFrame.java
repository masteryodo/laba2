...
import com.mycompany.laba2client.utils.Finder;
import com.mycompany.laba2client.utils.XmlReaderWriter;
import java.util.HashSet;
import com.mycompany.laba2client.utils.GenerateId;
...
public final class TestFrame extends javax.swing.JFrame {
    ...
    private ClientsTableModel clients_model;
    private OrdersTableModel orders_model;
    ...
    public TestFrame(ClientController controller) {
       ...
       refreshOrdersTableModel();
    }
    public void refreshClientsTableModel(){
        clients_model = new ClientsTableModel(clients, controller, this);
        jTable1.setModel(clients_model);
        //jTable1.revalidate();
    }
    
    public void refreshOrdersTableModel(){
        orders_model = new OrdersTableModel(orders, controller);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        //Добавление клиента
        clients.add(new Client(GenerateId.getId(), "", "", ""));
        refreshClientsTableModel();
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {// Добавление ордера
            // Если поле client_id не будет исправлено на действующее значение клиент не запищется.
            orders.add(new Order(GenerateId.getId(), new Long("0"), format.parse("01.01.1900"), new Double("0")) );
            refreshOrdersTableModel();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        Client client = getClientById( (Long) clients_model.getValueAt(row, 0));
        try {
            controller.sendClientUpdates("remove", client);
            clients = xml.readClientsFromXml(CLIENTS_FILE);
            refreshClientsTableModel();
        } catch (Exception ex) {
            Logger.getLogger(TestFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        System.out.println(orders_model.getValueAt(row, 1));
        long order_id = (Long) orders_model.getValueAt(row, 0);
        System.out.println(order_id);
        Order order = getOrderById(order_id);
        try {
            controller.sendOrderUpdates("remove", order);
            orders = xml.readOrdersFromXml(ORDERS_FILE);
            refreshOrdersTableModel();
        } catch (Exception e) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        clients = finder.findClientsByMask(clients, text);
        refreshClientsTableModel();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // сбросить фильтры и показать всех клиентов
        this.clients = xml.readClientsFromXml(CLIENTS_FILE);
        refreshClientsTableModel();
    }//GEN-LAST:event_jButton7ActionPerformed

    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        // сбросить фильтры и показать все ордера
        this.orders = xml.readOrdersFromXml(ORDERS_FILE);
        refreshOrdersTableModel();
    }//GEN-LAST:event_jButton8ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // Найти ордер по маске
        String text = jTextField2.getText();
        orders = finder.findOrdersByMask(orders, text);
        refreshOrdersTableModel();
    ...
    {   
        ...
        for (Order order : orders) {
            ...
            System.out.println("Получен id null");
        }
        return resultOrder;
    }
